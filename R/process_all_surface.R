#' Loop surface_light
#'
#' Iterates surface_light over directories containing deck**.csv files and CastTimes.csv files.
#'
#' @param dir.list A character vector containing filepaths for all of the directories containing light measurements from surface/deck archival tags.
